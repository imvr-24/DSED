...
class UI {
    ...
    initUI(weather) {
        ...
        if (weather.cod !== '404') {
            ...
            this.icon.setAttribute('src', `https://openweathermap.org/img/w/${weather.weather[index].icon}.png`);
    ...
    fillForecast(forecastData) {
        ...
        this.forecast_icon.setAttribute('src', `https://openweathermap.org/img/w/${list[index].weather[zeroIndex].icon}.png`);
